...
#if !defined(CY8C4045LQI_S411)
#error "Unexpected MPN; expected DEVICE:=CY8C4045LQI-S411. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CY8C4045LQI_S411) */
