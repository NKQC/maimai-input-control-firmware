...
#if defined (CY_USING_HAL)
const cyhal_resource_inst_t ioss_0_port_0_pin_6_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = ioss_0_port_0_pin_6_PORT_NUM,
    .channel_num = ioss_0_port_0_pin_6_PIN,
};
#endif /* defined (CY_USING_HAL) */
...
#if defined (CY_USING_HAL)
const cyhal_resource_inst_t ioss_0_port_2_pin_6_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = ioss_0_port_2_pin_6_PORT_NUM,
    .channel_num = ioss_0_port_2_pin_6_PIN,
};
#endif /* defined (CY_USING_HAL) */

const cy_stc_gpio_pin_config_t ioss_0_port_2_pin_7_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_ANALOG,
    .hsiom = ioss_0_port_2_pin_7_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
};
...
#if defined (CY_USING_HAL)
const cyhal_resource_inst_t ioss_0_port_2_pin_7_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = ioss_0_port_2_pin_7_PORT_NUM,
    .channel_num = ioss_0_port_2_pin_7_PIN,
};
#endif /* defined (CY_USING_HAL) */
...
void init_cycfg_pins(void)
{
    ...
    Cy_GPIO_Pin_Init(ioss_0_port_2_pin_7_PORT, ioss_0_port_2_pin_7_PIN, &ioss_0_port_2_pin_7_config);
...
void reserve_cycfg_pins(void)
{
    ...
    cyhal_hwmgr_reserve(&ioss_0_port_0_pin_6_obj);
    ...
    cyhal_hwmgr_reserve(&ioss_0_port_2_pin_6_obj);
    cyhal_hwmgr_reserve(&ioss_0_port_2_pin_7_obj);
