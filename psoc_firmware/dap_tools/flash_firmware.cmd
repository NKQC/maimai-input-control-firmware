...
OpenOCD\bin\openocd.exe -f interface/cmsis-dap.cfg -f target/psoc4.cfg -c "gdb_port disabled; transport select swd; adapter speed 1000; init; halt; flash write_image erase {%ABS_HEX_FILE_UNIX%}; reset; shutdown"
