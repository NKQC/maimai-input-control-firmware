...
#define COLOR_RED         0x001F  // 红色 (RGB565: R=0, G=0, B=31)
#define COLOR_GREEN       0x07E0  // 绿色 (RGB565: R=0, G=63, B=0)
#define COLOR_BLUE        0xF800  // 蓝色 (RGB565: R=31, G=0, B=0)
#define COLOR_YELLOW      0x07FF  // 黄色 (RGB565: R=0, G=63, B=31)
#define COLOR_CYAN        0xFFE0  // 青色 (RGB565: R=31, G=63, B=0)
